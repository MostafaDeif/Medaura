...
export default function DoctorRegisterPage() {
  ...
  function validate() {
    ...
    if (!experience) e.experience = "سنوات الخبرة مطلوبة";
      ...
      e.experience = "يجب أن تكون سنوات الخبرة رقماً صحيحاً";
  ...
  if (submitted) {
    return (
      <div className="text-center">
        ...
        <p className="text-zinc-600 mb-6">تم تسجيل الطبيب بنجاح (محلي فقط).</p>
        <button
          onClick={() => {
            setSubmitted(false);
            setName("");
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <select
            ...
            className={`w-full text-sm sm:text-base border rounded-md px-3 py-2 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:scale-[1.01] ${
              errors.specialty ? "border-red-300" : "border-zinc-200"
            }`}
          >
        ...
        <div>
          ...
          <input
            ...
            className={`w-full text-sm sm:text-base border rounded-md px-3 py-2 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:scale-[1.01] ${
              errors.experience ? "border-red-300" : "border-zinc-200"
            }`}
          />
          {errors.experience && (
            <p
